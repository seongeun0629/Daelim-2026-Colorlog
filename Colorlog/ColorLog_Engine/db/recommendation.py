...
{{
    "recommendations": [
        {{"product_name": "실제 올리브영 판매 제품명", "search_keyword": "브랜드명 제품종류", "category": "카테고리", "reason": "추천이유"}},
        {{"product_name": "실제 올리브영 판매 제품명", "search_keyword": "브랜드명 제품종류", "category": "카테고리", "reason": "추천이유"}},
        {{"product_name": "실제 올리브영 판매 제품명", "search_keyword": "브랜드명 제품종류", "category": "카테고리", "reason": "추천이유"}},
        {{"product_name": "실제 올리브영 판매 제품명", "search_keyword": "브랜드명 제품종류", "category": "스킨케어", "reason": "추천이유"}},
        {{"product_name": "실제 올리브영 판매 제품명", "search_keyword": "브랜드명 제품종류", "category": "스킨케어", "reason": "추천이유"}}
    ]
}}
...
- search_keyword: 올리브영 검색창에 입력할 짧은 키워드, 브랜드명+제품종류 2~4단어 이내 (예: 롬앤 틴트)
